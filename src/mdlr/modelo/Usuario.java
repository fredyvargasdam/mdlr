...
*/
    ...
    * Esta implementacion compara el campo id
    ...
    public String toString() {
        return "Usuario{" + "id_usuario=" + id_usuario + ", login=" + login + ", email=" + email + ", fullname=" + fullname + ", password=" + password + " lastPasswordChange=" + lastPasswordChange + ", direccion=" + direccion + ", telefono=" + telefono + '}';
    }
